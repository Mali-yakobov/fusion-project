...
public class VizualEllipse {
  ...
  public com.lynden.gmapsfx.shapes.Polyline ellipseToDraw(String color,double strokeWeight){
    ...
    org.jscience.geography.coordinates.UTM c= org.jscience.geography.coordinates.UTM.valueOf(zone, hemisphere, centreX, centreY,
                                                                                             SI.METRE);//find how convert center point to U
    ...
    PolylineOptions polylineOptions=new PolylineOptions().path(polyluneArray).strokeColor("blue").clickable(true).strokeWeight(strokeWeight);
